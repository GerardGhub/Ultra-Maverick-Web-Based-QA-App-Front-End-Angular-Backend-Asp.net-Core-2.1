...
export class ReturnedPOTransactionStatusComponent implements OnInit {
    ...
    @ViewChild("DescriptionStatus") DescriptionStatus: ElementRef;
    @ViewChild("DescriptionStatusUpdate") DescriptionStatusUpdate: ElementRef;
  ...
  onSaveClick()
  {
    ...
    {
      var ItemStatus = this.DescriptionStatus.nativeElement.value;
...
this.FieldOutRequiredField();
  ...
  onUpdateClick()
  {
var ItemStatus = this.DescriptionStatusUpdate.nativeElement.value;
